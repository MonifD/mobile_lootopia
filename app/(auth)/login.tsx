...
export default function LoginScreen() {
  ...
  return (
    ...
    >
      ...
      {/* la vidéo/animation sera rendue à l'intérieur de la carte pour rester collée au formulaire */}
      ...
      >
        ...
        >
          {/* Shadow shell — gives the plank its elevation */}
          <View style={styles.shadowShell}>

            {/* Animation React Native visible sans rebuild natif */}
            <LoginAura />

            {/* Bright bevel (top-left edge) */}
            <LinearGradient
              ...
              >
                ...
                >
                  ...
                  <View style={styles.cardContent}>
                    ...
                    <Text style={[styles.badge, { fontFamily: orbitron }]}>
                      Lootopia Explorer
                    </Text>

                    <Text style={[styles.title, { fontFamily: orbitron }]}>
                      Connexion
                    </Text>

                    <ThemedText style={styles.subtitle}>
                      Connecte-toi pour reprendre ta chasse au trésor.
                    </ThemedText>
                        ...
                        >
                          ...
                          {isLoading ? (
                            <View style={styles.loadingRow}>
                              ...
                              <Text style={[styles.ctaText, { fontFamily: orbitron }]}>
                                Connexion...
                              </Text>
                            </View>
                          ) : (
                    ...
                    <View style={styles.footerRow}>
                      ...
                      <Link href="/register" asChild>
                        <Pressable style={({ pressed }) => [styles.linkButton, pressed && styles.buttonLift]}>
                          <Text style={[styles.linkText, { fontFamily: orbitron }]}>
                            Créer un compte
                          </Text>
                        </Pressable>
                      </Link>
